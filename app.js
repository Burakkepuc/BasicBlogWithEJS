...
app.get("/contact",function(req,res){
  res.render('contact',{ejsContactContect: contactContent});
});

app.get("/compose",function(req,res){
  res.render('compose',{ejsComposeH1 : "Compose "});
});
...
//    console.log( postName );
  posts.forEach(function(post){ //To access all individual elements
